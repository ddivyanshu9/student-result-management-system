...
class resultClass:
    def __init__(self,root):
        ...
        #=====title=====
        title = Label(self.root,text = "Student Results details",font =("goudy old style",20,"bold"),bg = "orange",fg="#262626").place(x=10,y=50,width=1180,height =35)
#=================widgets==================
#=============Variable=====================
...
#====================button====================
        ...
        btn_add=Button(self.root,text="Submit",font=("goudy old style",15),bg="lightgreen",activebackground="blue",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_clear=Button(self.root,text="Clear",font=("goudy old style",15),bg="lightgray",activebackground="orange",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
#=========================================================================================
    def fetch_roll(self):
